 ...
 * generated in the de.algoristic.tutorials.xml package. 
...
public class ObjectFactory {
    ...
    private final static QName _Employee_QNAME = new QName("https://algoristic.de/employee", "employee");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.algoristic.tutorials.xml
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://algoristic.de/employee", name = "employee")
