...
- The attribute `date` of `birthday` will be automatically validated using the YYYY-MM-DD format (see [w3schools](https://www.w3schools.com/XML/schema_dtypes_date.asp)) for more information on this).
